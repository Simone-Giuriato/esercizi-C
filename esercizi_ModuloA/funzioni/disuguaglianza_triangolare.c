...
int main(){
    ...
    risultato=disuguaglianza(l1,l2,l3);

    if(risultato==1){
        printf("Il primo lato è minore o uguale della somma degli altri due\n");
    }else{
        printf("Il primo lato è maggiore della somma degli altri due, e non costituisce un triangolo\n");
    }
